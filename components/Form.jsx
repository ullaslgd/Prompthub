  ...
  return (
    <section className="w-full max-w-full flex-start flex-col">
      ...
      <p className="desc text-left max-w-md">
        {type} a post to share with the world 
        and let your imagination run wild with any ai powered platform.
      </p>
      <form onSubmit={handlesubmit} className="mt-10 w-full max-w-2xl flex flex-col gap-7 glassmorphism">
        
          <label>
            <span className="font-satoshi font-semibold text-base text-gray-700">Enter Your AI Prompt </span>
            </label>
          ...
          <label>
            <span className="font-satoshi font-semibold text-base text-gray-700">Tag {` `}<span className="font-normal">(#product, #webdevelopment #AIML)</span></span>
            </label>
